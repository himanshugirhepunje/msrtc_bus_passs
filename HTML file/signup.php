...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        echo "<script>alert('Email or Phone Number already registered! Please login or use a different one.');</script>";
    } else {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Signup Successful! Login Now'); window.location.href='login.php';</script>";
        } else {
...
<script>
  ...
  if (!passwordPattern.test(password)) {
    document.getElementById('password-error').innerHTML = 'Password must be at least 8 characters long and include at least one uppercase letter, one lowercase letter, one number, and one special character (@$!%?&).';
    isValid = false;
  }
...
<body>
    ...
    <div class="wrapper">
        ...
        <form id="signup-form" method="post" action="signup.php" onsubmit="return validateForm()">
        <div class="row">
          ...
          <div class="row">
            ...
            <div id="email-error" class="error" style="color: red;"></div><br>
          </div> 
          <br><div class="row">
        ...
        <div class="row">
          ...
          <div class="signup-link">Already a user? <a href="login.php">Login here</a></div>
        </form>
      </div>
      </div>
