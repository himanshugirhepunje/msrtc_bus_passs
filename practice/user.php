...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO users ( name, phone, passward) 
            VALUES ( '$name', '$phone', '$passward')";
...
<body>
    ...
    <div class="wrapper">
        ...
        <form id="signup-form" method="post" action=" " onsubmit="return validateForm()">
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="signup-link">Already a user? <a href="newlogin.php">Login here</a></div>
        </form>
      </div>
      </div>
